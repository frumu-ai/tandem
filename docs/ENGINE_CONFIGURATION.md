...
| `TANDEM_CONTEXT_ASSERTION_REPLAY_STORE_FILE`  | `unset`               | Shared durable replay-state file. Required and opened before bind in hosted/enterprise mode; Unix state and lock files require owner-only permissions and reject symlinks.                        |
