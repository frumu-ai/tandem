...
- A HMAC-chained, externally anchored, fsync-durable protected audit ledger with verifiable export bundles (`/audit/ledger/manifest`, `/audit/ledger/export`) and governance evidence completeness checks that cross-reference protected actions, approvals, tool effects, and audit events.
