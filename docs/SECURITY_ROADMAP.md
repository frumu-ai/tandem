...
- **Code**: `apps/tandem-desktop/src-tauri/src/state.rs` (and any path allowlist logic)
- **Done when**:
...
- **Config**: `apps/tandem-desktop/src-tauri/tauri.conf.json` (`app.security.assetProtocol.scope`)
- **Done when**:
...
- **Code**: `apps/tandem-desktop/src-tauri/src/sidecar.rs` and sidecar API calls
- **Done when**:
...
- **Config**: `apps/tandem-desktop/src-tauri/tauri.conf.json` (`app.security.csp`)
- **Done when**:
