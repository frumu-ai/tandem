...
pub fn run() {
    ...
    let mut builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::incident_monitor_get_config,
            commands::incident_monitor_patch_config,
            commands::incident_monitor_get_status,
            commands::incident_monitor_list_drafts,
            commands::incident_monitor_get_draft,
            commands::incident_monitor_report,
            commands::incident_monitor_approve_draft,
            commands::incident_monitor_deny_draft,
            commands::incident_monitor_create_triage_run,
            commands::coder_list_runs,
            commands::coder_get_run,
            commands::context_run_rollback_preview,
            commands::context_run_rollback_execute,
            commands::context_run_rollback_history,
            commands::coder_get_project_binding,
            commands::coder_put_project_binding,
            commands::coder_get_project_github_inbox,
            commands::coder_intake_project_item,
            commands::coder_list_artifacts,
            commands::coder_get_memory_hits,
            commands::coder_list_memory_candidates,
            commands::coder_approve_run,
            commands::coder_cancel_run,
            commands::setup_understand,
            commands::pack_builder_preview,
            commands::pack_builder_apply,
            commands::pack_builder_cancel,
            commands::pack_builder_pending,
            commands::tool_ids,
            ...
            commands::workflow_plans_get,
            commands::automations_v2_list,
            commands::automations_v2_get,
            commands::automations_v2_update,
            commands::automations_v2_delete,
            ...
            commands::routines_run_pause,
            commands::routines_run_resume,
            commands::routines_run_artifacts,
            commands::routines_run_add_artifact,
            ...
            commands::orchestrator_engine_create_run,
            commands::orchestrator_start,
            commands::orchestrator_engine_start,
            commands::orchestrator_get_run,
            commands::orchestrator_engine_get_run,
            commands::orchestrator_get_events,
            commands::orchestrator_engine_get_events,
            commands::orchestrator_get_blackboard,
            commands::orchestrator_engine_get_blackboard,
            commands::orchestrator_engine_get_latest_checkpoint,
            commands::orchestrator_engine_get_replay,
            commands::orchestrator_get_blackboard_patches,
            commands::orchestrator_get_budget,
            commands::orchestrator_list_tasks,
            commands::orchestrator_engine_list_tasks,
            ...
            commands::orchestrator_engine_approve,
            commands::orchestrator_request_revision,
            commands::orchestrator_engine_request_revision,
            commands::orchestrator_engine_retry_task,
            commands::orchestrator_pause,
            commands::orchestrator_engine_pause,
            commands::orchestrator_resume,
            commands::orchestrator_engine_resume,
            commands::orchestrator_cancel,
            commands::orchestrator_engine_cancel,
            commands::orchestrator_list_runs,
            commands::orchestrator_engine_list_runs,
            commands::orchestrator_load_run,
            commands::orchestrator_engine_load_run,
