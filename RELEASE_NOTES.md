...
- **Workflow learning API coverage**: Added focused HTTP coverage for workflow learning candidate listing, review, promotion, and revision-spawn guardrails so the new surfaces keep deterministic behavior around missing candidates, invalid filters, and missing plan bundles.
