...
/**
 * Returns the element in the array that yields the maximum value for the given function.
 * This is an O(N) performance optimization avoiding the O(N log N) overhead of
 * [...arr].sort((a, b) => getValue(b) - getValue(a))[0].
 */
...
/**
 * Returns the element in the array that yields the minimum value for the given function.
 * This is an O(N) performance optimization avoiding the O(N log N) overhead of
 * [...arr].sort((a, b) => getValue(a) - getValue(b))[0].
 */
