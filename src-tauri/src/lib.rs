...
pub fn run() {
    ...
    let mut builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::bug_monitor_get_config,
            commands::bug_monitor_patch_config,
            commands::bug_monitor_get_status,
            commands::bug_monitor_list_drafts,
            commands::bug_monitor_get_draft,
            commands::bug_monitor_report,
            commands::bug_monitor_approve_draft,
            commands::bug_monitor_deny_draft,
            commands::bug_monitor_create_triage_run,
