...
The standalone eval CLI supports simulation mode directly, and stub/live modes bootstrap an isolated in-process `AppState` when no remote engine token is provided.
