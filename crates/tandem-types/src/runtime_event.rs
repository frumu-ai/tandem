...
runtime_event_types! {
    ...
    IncidentMonitorError => "incident_monitor.error",
    IncidentMonitorGithubCommentPosted => "incident_monitor.github.comment_posted",
    IncidentMonitorGithubIssueCreated => "incident_monitor.github.issue_created",
    IncidentMonitorIncidentDetected => "incident_monitor.incident.detected",
    IncidentMonitorIncidentDuplicateSuppressed => "incident_monitor.incident.duplicate_suppressed",
    IncidentMonitorIncidentTriageFailed => "incident_monitor.incident.triage_failed",
    IncidentMonitorIncidentTriageTimedOut => "incident_monitor.incident.triage_timed_out",
    IncidentMonitorTriageRunCreated => "incident_monitor.triage_run.created",
    ...
    DataBoundaryApprovalRequired => "data_boundary.approval_required",
    DataBoundaryBlocked => "data_boundary.blocked",
    DataBoundaryEvaluated => "data_boundary.evaluated",
    DataBoundaryRedacted => "data_boundary.redacted",
    DataBoundaryRoutedLocal => "data_boundary.routed_local",
    DataBoundaryTokenized => "data_boundary.tokenized",
