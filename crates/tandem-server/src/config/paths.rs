...
pub(crate) fn resolve_enterprise_org_unit_memberships_path() -> PathBuf {
...
pub(crate) fn resolve_enterprise_ingestion_quarantines_path() -> PathBuf {
    resolve_canonical_data_file_path("enterprise/ingestion_quarantines.json")
}
...
pub(crate) fn resolve_benchmark_runs_dir() -> PathBuf {
    resolve_canonical_data_file_path("benchmarks/runs")
}
