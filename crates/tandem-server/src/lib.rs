...
pub use automation_v2::execution_profile::{
    ...
    effective_repair_budget, parse_execution_profile_str, parse_validator_class_list,
    propagate_experimental_input_taint, tenant_default_execution_profile_from_env,
    tenant_relaxation_denylist_from_env, ExecutionProfile, ProfileValidationDecision,
    RelaxedValidatorClass, ValidationOutcome, ValidatorClass,
};
