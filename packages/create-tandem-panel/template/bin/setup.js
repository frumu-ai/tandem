...
const STATIC_DISABLED = (process.env.TANDEM_CONTROL_PANEL_DISABLE_STATIC || "0") === "1";
...
async function ensureEngineRunning() {
  ...
  try {
    ...
    err("Install dependencies with: npm install");
    throw e;
  }
...
async function main() {
  ...
  if (!STATIC_DISABLED && !existsSync(DIST_DIR)) {
