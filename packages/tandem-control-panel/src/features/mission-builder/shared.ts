...
export function buildIntentToMissionBlueprintPrompt(input: {
  ...
  return [
    ...
    "- Use 1 to 7 scoped workstreams with one responsibility each.",
    "- Honor an explicit requested stage or workstream count when it can form a valid DAG.",
    "- A compact generic-webhook mission may use two workstreams plus one explicit approval stage: inspect and draft -> approval -> write.",
    "- Do not add filler collection, review, audit, or reporting stages merely to increase the stage count.",
