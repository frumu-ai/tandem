...
export interface IncidentMonitorLogSourceRuntimeStatus {
  project_id?: string;
  source_id?: string;
  path?: string;
  healthy?: boolean;
...
export interface IncidentMonitorLogWatcherStatus {
  running?: boolean;
  enabled_projects?: number;
  enabled_sources?: number;
  last_poll_at_ms?: number | null;
  last_error?: string | null;
  sources?: IncidentMonitorLogSourceRuntimeStatus[];
}
...
export interface IncidentMonitorIncidentRecord {
  ...
  external_correlation_ids?: string[];
...
export interface IncidentMonitorIntakeKeyRecord {
  key_id: string;
  project_id: string;
  name: string;
  key_hash?: string;
...
export interface IncidentMonitorIntakeKeyListResponse {
  keys: IncidentMonitorIntakeKeyRecord[];
}

export interface IncidentMonitorIntakeKeyCreateInput {
  project_id: string;
  name: string;
  scopes?: string[];
}

export interface IncidentMonitorIntakeKeyCreateResponse {
  key: IncidentMonitorIntakeKeyRecord;
  raw_key: string;
}

export interface IncidentMonitorIntakeKeyDisableResponse {
  key: IncidentMonitorIntakeKeyRecord;
}

export interface IncidentMonitorLogSourceStateRecord {
  project_id?: string;
  source_id?: string;
  path?: string;
  inode?: string | null;
...
export interface IncidentMonitorLogSourceResetResponse {
  project_id: string;
  source_id: string;
  state: IncidentMonitorLogSourceStateRecord;
}

export interface IncidentMonitorLogSourceReplayResponse {
  project_id: string;
  source_id: string;
  incident: IncidentMonitorIncidentRecord;
  draft?: IncidentMonitorDraftRecord | null;
}
